...
#define FAL_JUST_INDEX (11)

const int vanillaKey[] = {4, 6, 4, 4, 4, 0, 8, 1, 1, 1, 1, 3, 3};

void setVanilla(GameRule *rule) {
...
void doubleDecker(GameRule *rule) {
    for (int i = 0; i < NUM_OF_CARD_TYPE; i++) {
